...
function M.check_properties(spec)
  ...
  assert.is.truthy(spec.syntax.keyword)
  ...
  assert.is.truthy(spec.lualine.normal)
  assert.is.truthy(spec.lualine.visualfg)
  assert.is.truthy(spec.lualine.visual)
  assert.is.truthy(spec.lualine.replacefg)
  assert.is.truthy(spec.lualine.replace)
  assert.is.truthy(spec.lualine.insertfg)
  assert.is.truthy(spec.lualine.insert)
  assert.is.truthy(spec.lualine.commandfg)
  assert.is.truthy(spec.lualine.command)
  assert.is.truthy(spec.lualine.terminalfg)
  assert.is.truthy(spec.lualine.terminal)
  assert.is.truthy(spec.lualine.inactivefg)
  assert.is.truthy(spec.lualine.inactive)
end
...
function M.check_typeof(spec)
  ...
  assert.are.same(property_expected_type, type(spec.syntax.keyword))
  ...
  assert.are.same(property_expected_type, type(spec.lualine.normal))
  assert.are.same(property_expected_type, type(spec.lualine.visualfg))
  assert.are.same(property_expected_type, type(spec.lualine.visual))
  assert.are.same(property_expected_type, type(spec.lualine.replacefg))
  assert.are.same(property_expected_type, type(spec.lualine.replace))
  assert.are.same(property_expected_type, type(spec.lualine.insertfg))
  assert.are.same(property_expected_type, type(spec.lualine.insert))
  assert.are.same(property_expected_type, type(spec.lualine.commandfg))
  assert.are.same(property_expected_type, type(spec.lualine.command))
  assert.are.same(property_expected_type, type(spec.lualine.terminalfg))
  assert.are.same(property_expected_type, type(spec.lualine.terminal))
  assert.are.same(property_expected_type, type(spec.lualine.inactivefg))
  assert.are.same(property_expected_type, type(spec.lualine.inactive))
end
